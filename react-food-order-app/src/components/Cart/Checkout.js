...
const isGreaterOrEqualToFiveChars = value => value.trim().length >= 5;
...
const Checkout = (props) => {
    ...
    const confirmHandler = (event) => {
        ...
        const enteredPostalCodeIsValid = isGreaterOrEqualToFiveChars(enteredPostalCode)
    ...
    return <form onSubmit={confirmHandler} className={classes.form}>
        ...
        <div className={postalCodeControlClasses}>
            ...
            {!formInputValidity.postalCode && <p>Please enter a valid postal code is 5 or more characters long!</p>}
        </div>
